...
pincodes = {
    'basakvishwa95@gmail.com':['208001','208017','208002','208004','208011'],
    'suyash2896@gmail.com':['201301','201014']
}
...
def send_mail(found_info,receiver_id):
    if len(found_info)>1:
        ...
        message['Subject'] = 'Found slots in your requested pincodes!'
        message['From'] = "noreply.vaccines@gmail.com"
        ...
        server.starttls()
        server.login(message['From'], 'covid@19')
